...
export default async function Biux({ lang = 'en' }: { lang: Locale }) {
  ...
  return (
    <div
      style={{ maxWidth: 1200 }}
      className='relative flex gap-10 items-center  mt-16 max-lg:flex-col flex-row-reverse  bg-white dark:bg-transparent shadow-lg dark:bg-gradient-to-br from-base-200 to-base-100 p-10 border border-content-300/20 '
    >
