  ...
  return (
    <>
      <div
        ...
        className='group  rounded-3xl  text-content-100 bg-transparent absolute h-full w-full top-0 left-0 flex flex-col items-center justify-center z-2 transition-[background] ease-in  cursor-pointer'
      >
